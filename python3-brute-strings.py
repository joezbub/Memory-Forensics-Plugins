...
def find_instance(task, class_name):
    ...
    for heap_vma in heaps:
        #if heap_vma.vm_start in [10817536, 23433216, 139626311200768]:
        #    continue
        #print "brute force: ", heap_vma.vm_start
        tmp_instances = []
        tmp_instances.extend(brute_force_search(
        ...
        found_instances.extend(tmp_instances)
    sys.exit(0)
