...
Volatility plugins to find self-driving car information on a [CARLA](https://carla.org) memory dump. Currently, I have three plugins: `linux_find_instances`, `linux_python_brute_strings`, and `testplug`.
...
To execute the plugin found in `python-brute-strings.py`, execute:
